...
class TabienrodnamchockDatatBuilderAgent
  ...
  def create_log_file
    ...
    $logger = Logger.new("#{File.dirname(__FILE__)}/logs/tabienrodnamchock_data_builder_agent.log", 'weekly')
  ...
  def start_processing
    begin
      if $db_connection_established
        urls = ["https://www.tabienrodnamchock.com"]
          ...
          listings.each do |each_list|
            ...
            listings_1.each_with_index do |each_data, ind|
              begin
                ...
                if each_data.to_s.include?"https://www.tabienrodnamchock.com/img/purple.png"
                  color = 'white special'
                elsif each_data.to_s.include?"https://www.tabienrodnamchock.com/img/white.png"
                  color = 'white'
                elsif each_data.to_s.include?"https://www.tabienrodnamchock.com/img/phuket.png"
                  color = 'phuket'
                elsif each_data.to_s.include?"https://www.tabienrodnamchock.com/img/choburi.jpg"
                  color = 'chonburi'
                elsif each_data.to_s.include?"https://www.tabienrodnamchock.com/img/gold.png"
                  color = 'gold'
                elsif each_data.to_s.include?"https://www.tabienrodnamchock.com/img/ggreen.png"
                  color = 'green special'
                elsif each_data.to_s.include?"https://www.tabienrodnamchock.com/img/gblue.png"
                  color = 'blue special'
                elsif each_data.to_s.include?"https://www.tabienrodnamchock.com/img/blue.png"
                  color = 'blue basic'
                elsif each_data.to_s.include?"https://www.tabienrodnamchock.com/img/rayong.jpg"
                  color = 'rayong'
                elsif each_data.to_s.include?"https://www.tabienrodnamchock.com/img/songkra.jpg"
                  color = 'songkla'
                elsif each_data.to_s.include?"https://www.tabienrodnamchock.com/img/nara.png"
                  color = 'nara'
                else
                  color = ''
                end
                ...
                if exist_data.count == 0
                  ...
                  results = TabienrodnamchockDetail.create(:date_created => date_created, :url => each_url, :license_group => license_group, :license_number => license_number, :price => price, :location => location, :license_status => status, :color => color, :processing_status => '')
                end
              rescue Exception => e
  ...
  def update_status
    ...
    results5 = ActiveRecord::Base.connection.exec_query("select distinct(Concat(date_created,url)),date_created,url from tabienrodnamchock_details where processing_status = '' order by date_created desc ")
    ...
    results1 = ActiveRecord::Base.connection.exec_query("select distinct(Concat(date_created,url)),date_created,url from tabienrodnamchock_details where processing_status = '' order by date_created desc ")
...
optparse = OptionParser.new do|opts|
  ...
  # of the help screen.
  opts.banner = "Usage: ruby tabienrodnamchock_data_agent.rb [options]"
  ...
  opts.on( '-e', '--env ENVIRONMENT', 'Run the new tabienrodnamchock agent for building the projects' ) do |env|
    options[:env] = env
  end
