...
require 'logger' 
						...
						$logger = Logger.new("#{File.dirname(__FILE__)}/logs/lekpramool_data_monitor.log", 'weekly')
						#~ $logger.level = Logger::DEBUG
						$logger.formatter = Logger::Formatter.new

#~ while true do
pid_status_english = system("ps -aux | grep lekpramool_data_agent.rb | grep -vq grep")
