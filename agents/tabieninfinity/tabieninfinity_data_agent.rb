      ...
      v.each do |s|
        ...
        results.each do |res|
          ...
          if results_current.count == 0
            ...
            # byebug
            TabieninfinityDetail.create(:url => k, :license_group => license_group, :license_number => license_number, :price => price, :license_status => license_status, :location => location, :date_created => date_created, :processing_status => processing_status)
          end
        end
      end
    end
