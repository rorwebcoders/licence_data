          ...
          listings.each do |each_list|
            ...
            listings_1.each_with_index do |each_data, ind|
              begin
                ...
                if each_data.to_s.include?"https://www.raktabien.com/img/purple.png"
                  color = 'white special'
                elsif each_data.to_s.include?"https://www.raktabien.com/img/white.png"
                  color = 'white'
                elsif each_data.to_s.include?"https://www.raktabien.com/img/phuket.png"
                  color = 'phuket'
                elsif each_data.to_s.include?"https://www.raktabien.com/img/choburi.jpg"
                  color = 'chonburi'
                elsif each_data.to_s.include?"https://www.raktabien.com/img/gold.png"
                  color = 'gold'
                elsif each_data.to_s.include?"https://www.raktabien.com/img/ggreen.png"
                  color = 'green special'
                elsif each_data.to_s.include?"https://www.raktabien.com/img/gblue.png"
                  color = 'blue special'
                elsif each_data.to_s.include?"https://www.raktabien.com/img/blue.png"
                  color = 'blue basic'
                elsif each_data.to_s.include?"https://www.raktabien.com/img/rayong.jpg"
                  color = 'rayong'
                elsif each_data.to_s.include?"https://www.raktabien.com/img/songkra.jpg"
                  color = 'songkla'
                elsif each_data.to_s.include?"https://www.raktabien.com/img/nara.png"
                  color = 'nara'
                else
                  color = ''
                end
                ...
                if exist_data.count == 0
                  ...
                  results = RaktabienDetail.create(:date_created => date_created, :url => each_url, :license_group => license_group, :license_number => license_number, :price => price, :location => location, :license_status => status, :color => color, :processing_status => '')
                end
              rescue Exception => e
